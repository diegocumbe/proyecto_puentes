...
def listado():
    ...
    return render_template('listado.html',registro_de_puentes=data)
...
def P_peatonal():
    ...
    return render_template('P_peatonal.html',registro_de_puentes=data)
...
def P_vehicular():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('P_vehicular.html',registro_de_puentes=data)
...
def comuna1():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna1.html',registro_de_puentes=data)
...
def comuna2():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna2.html',registro_de_puentes=data)
...
def comuna3():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna3.html',registro_de_puentes=data)
...
def comuna4():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna4.html',registro_de_puentes=data)
...
def comuna5():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna5.html',registro_de_puentes=data)
...
def comuna6():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna6.html',registro_de_puentes=data)
...
def comuna7():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna7.html',registro_de_puentes=data)
...
def comuna8():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna8.html',registro_de_puentes=data)
...
def comuna9():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna9.html',registro_de_puentes=data)
...
def comuna10():
    ...
    data = cur.fetchall()
    cur.close()
    return render_template('comuna10.html',registro_de_puentes=data)
@app.route('/ver')
def ver():
